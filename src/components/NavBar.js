                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a href="https://www.linkedin.com/in/wallacefelipe21/" target="_blank"><img src={NavIcon1} alt=""/></a>
                            <a href="https://github.com/wallacefelipe21" target="_blank"><img className="img-git" src={NavIcon2} alt=""/></a>
                            <a href="https://www.instagram.com/wllc.felipe/" target="_blank"><img src={NavIcon3} alt=""/></a>
                        </div>
                        <button className="vvd" onClick={() => console.log('connect')}><span> Let's Gooooo </span></button> 
                    </span>
                </Navbar.Collapse>
            </Container>
        </Navbar>
